...
void help(void){
	printf("=========================================================\n");
	printf(" jt: A language for tree and graph structure description \n");
	printf("=========================================================\n");
	printf("\n");
	printf("DEVELOPER\n");
	printf("*********\n");
	...
	printf("*****\n");
	printf("\n");
	printf(" jt [-h|-hF|-hC|-hS|-hD|-hE] [-s] [-c] [-test] buff=<(int)size> in=<file name of input form> out=<file name of outout form> data=<data file> data_buff=<(int)size> w=<warnning level> -F<x> -C<x> -P<x>.\n");
	printf("\n");
...
int main(int argc, char **argv){
	...
	if(strlen((*opt).out) > 0){
		...
		otop = import_Tree(IN,opt,_fopt,_copt,_sopt,&node_count/*, SAK EFLAG,NULL */);
