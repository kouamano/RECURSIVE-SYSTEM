...
*********************************************************************/
   ...
   if (argc == 5)
      ...
      strncpy(&option,argv[3],1);     /* Analysis option */
      }
   ...
   /* Look at analysis option; branch in accordance with this. */
     ...
     switch(option)
          ...
          case 'S':
          case 's':
              //printf("\"Analysis of sums-of-squares-cross-products matrix chosen.\",\n");
...
**********************************************************************/
     ...
     */
     ...
     printf("{\n");
     printf(" { ");
     printf("%12.4f", symmat[1][m-1+1]);
     for (i = 2; i <= m; i++) {
        printf(",%12.4f", symmat[1][m-i+1]);
     }
     printf(" }\n");

     for (j = 2; j <= m; j++) {
       printf(",{ ");
       printf("%12.4f", symmat[j][m-1+1]);
       for (i = 2; i <= m; i++) {
     ...
     */
     ...
     //printf("\n\"Projections of row-points on first m prin. comps.:\",\n");
     //printf("{\n");
     //printf(" { ");
     printf("%f", data[1][1]);
     for (j = 2; j <= m; j++)  {
     ...
     printf("{\n");
     printf(" { ");
     printf(" %12.4f", symmat2[1][1]);
     for (k = 2; k <= m; k++) {
        printf(",%12.4f", symmat2[1][k]);
     }
     printf("}\n");

     for (j = 2; j <= m; j++) {
       printf(",{ ");
       printf(" %12.4f", symmat2[j][1]);
       for (k = 2; k <= m; k++) {
