...
sub print_usage{
	...
	print("ssvsearch.pl [--check] [-c|-r] [k=\"field No.\"] t=\"search term\" [if=\"input file\"] [idf=\"input data form\"] [of=\"output file\"] [odf=\"output data form\"] [-a|-m]\n\tsearch the term(s) from the file.\n");
	print("options \n");
	...
	#print("\tidf=\"input data form\" : data table (d), title (t).\n");
	print("\todf=\"output data form\" : data table (d),  position (p).\n");
	print("\t-a|-m : printout hole line (-a) or matched field only (-m).\n");
}
